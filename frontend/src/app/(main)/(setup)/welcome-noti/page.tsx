...
// InfoIcon component - moved outside render
const InfoIcon = () => (
...
// WindowsIcon component - moved outside render
const WindowsIcon = () => (
...
// MacIcon component - moved outside render
const MacIcon = () => (
  <div className="w-6 h-6 flex items-center justify-center">
    <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
...
// AndroidIcon component - moved outside render
const AndroidIcon = () => (
  <div className="w-6 h-6 flex items-center justify-center">
    <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
...
// OS tabs configuration - moved outside render to avoid creating components during render
const osTabs = [
  { name: "Windows", IconComponent: WindowsIcon },
  { name: "Mac", IconComponent: MacIcon },
  { name: "Android", IconComponent: AndroidIcon }
];
